Public Class frmFindMaterials
    ...
    Sub purchaseOrderFunction()
        ...
        If frmPurchaseOrder.chkboxLessVat.Checked = True Then
            frmPurchaseOrder.dgw.Item(4, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(6).Value
            frmPurchaseOrder.dgw.Item(6, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(6).Value * qty
