Public Class frmPurchaseOrder
    ...
    Sub addtoDGW()
        ...
        dgw.Item(2, rows).Value = txtDebitTo.Text
        ...
        If chkboxLessVat.Checked = True Then
            dgw.Item(5, rows).Value = txtUnitPrice.Text * 1 / 1.12
            totalAmount = totalAmount + txtUnitPrice.Text * txtQuantity.Text / 1.12
            dgw.Item(7, rows).Value = txtUnitPrice.Text * txtQuantity.Text / 1.12
        Else
    ...
    Sub dgwItemProcess()
        ...
        While col < row1
            ...
            debitTo = dgw.Item(2, col).Value
            unit = dgw.Item(3, col).Value
            uprice = dgw.Item(4, col).Value
            lessVat = dgw.Item(5, col).Value
