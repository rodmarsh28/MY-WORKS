Public Class frmFindMaterials
    ...
    Sub materialsReceivingFunction()
        ...
        frmMaterialReceiving.dgw.Item(7, frmMaterialReceiving.rows).Value = qty
        frmMaterialReceiving.dgw.Item(6, frmMaterialReceiving.rows).Value = dgw.CurrentRow.Cells(7).Value
        frmMaterialReceiving.dgw.Item(5, frmMaterialReceiving.rows).Value = dgw.CurrentRow.Cells(5).Value
        If frmMaterialReceiving.chkboxLessVat.Checked = True Then
            frmMaterialReceiving.dgw.Item(8, frmMaterialReceiving.rows).Value = dgw.CurrentRow.Cells(7).Value * qty
            frmMaterialReceiving.totalAmount = frmMaterialReceiving.totalAmount + dgw.CurrentRow.Cells(7).Value * qty
        Else
            frmMaterialReceiving.dgw.Item(8, frmMaterialReceiving.rows).Value = dgw.CurrentRow.Cells(5).Value * qty
            frmMaterialReceiving.totalAmount = frmMaterialReceiving.totalAmount + dgw.CurrentRow.Cells(5).Value * qty
        End If
    ...
    Sub purchaseOrderFunction()
        ...
        frmPurchaseOrder.dgw.Item(2, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(4).Value
        frmPurchaseOrder.dgw.Item(3, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(5).Value
        If frmPurchaseOrder.chkboxLessVat.Checked = True Then
            frmPurchaseOrder.dgw.Item(4, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(7).Value
            frmPurchaseOrder.dgw.Item(6, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(7).Value * qty
            frmPurchaseOrder.totalAmount = frmPurchaseOrder.totalAmount + dgw.CurrentRow.Cells(7).Value * qty
        Else
            frmPurchaseOrder.dgw.Item(4, frmPurchaseOrder.rows).Value = 0
            frmPurchaseOrder.dgw.Item(6, frmPurchaseOrder.rows).Value = dgw.CurrentRow.Cells(5).Value * qty
    ...
    Sub purchaseRequesitionFunction()
        ...
        frmPurchaseRequestSlip.dgw.Item(3, frmPurchaseRequestSlip.rows).Value = dgw.CurrentRow.Cells(4).Value
        frmPurchaseRequestSlip.dgw.Item(4, frmPurchaseRequestSlip.rows).Value = qty
        frmPurchaseRequestSlip.dgw.Item(5, frmPurchaseRequestSlip.rows).Value = dgw.CurrentRow.Cells(5).Value
    ...
    Sub materialIssuanceFunction()
        ...
        Else
            ...
            Else
                ...
                frmMaterialsIssuance.dgw.Item(4, frmMaterialsIssuance.rows).Value = dgw.CurrentRow.Cells(4).Value
                frmMaterialsIssuance.dgw.Item(5, frmMaterialsIssuance.rows).Value = qty
                frmMaterialsIssuance.dgw.Item(6, frmMaterialsIssuance.rows).Value = dgw.CurrentRow.Cells(6).Value
                frmMaterialsIssuance.dgw.Item(7, frmMaterialsIssuance.rows).Value = dgw.CurrentRow.Cells(6).Value * qty
