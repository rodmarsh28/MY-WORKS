        ...
        Try
            ...
            If OleDBDR.HasRows Then
                While OleDBDR.Read
                    ...
                    frmPurchaseOrder.dgw.Item(2, c).Value = OleDBDR.Item(4)
                    frmPurchaseOrder.dgw.Item(3, c).Value = OleDBDR.Item(5)
                    frmPurchaseOrder.dgw.Item(4, c).Value = OleDBDR.Item(8)
                    frmPurchaseOrder.dgw.Item(5, c).Value = OleDBDR.Item(6)
                    frmPurchaseOrder.dgw.Item(6, c).Value = OleDBDR.Item(7)
                    c = c + 1
