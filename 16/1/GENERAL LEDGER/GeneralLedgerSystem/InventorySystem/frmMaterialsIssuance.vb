Public Class frmMaterialsIssuance
    ...
    Sub dgwItemProcess()
        ...
        While col < row1
            ...
            ACQUISITIONUNITCOST = dgw.Item(6, col).Value
            ACQUISITIONCOST = dgw.Item(7, col).Value
            saveItem()
            stocksUpdate()
            col = col + 1
        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblMISDESC.MISNO,dbo.tblMISDESC.[DATE],dbo.tblMISDESC.MWSREF,dbo.tblMISDESC.[SECTION],dbo.tblMISDESC.DEPARTMENT," & _
                    ...
                    "dbo.tblMISITEM.ITEMCATEGORIES,dbo.tblMISITEM.UNIT,dbo.tblMISITEM.QTY FROM dbo.tblMISITEM INNER JOIN dbo.tblMISDESC ON dbo.tblMISITEM.MISNO = dbo.tblMISDESC.MISNO WHERE dbo.tblMISDESC.MISNO = '" & txtMisNo.Text & "'"
            End With
            OleDBDR = OleDBC.ExecuteReader
