        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblMWSDESC.MWSDESCNO,dbo.tblMWSDESC.[DATE],dbo.tblMWSDESC.[TO],dbo.tblMWSDESC.[SECTION]," & _
                    ...
                    "dbo.tblMWSITEM.QTY FROM dbo.tblMWSDESC INNER JOIN dbo.tblMWSITEM ON dbo.tblMWSDESC.MWSDESCNO = dbo.tblMWSITEM.MWSDESCNO where dbo.tblMWSDESC.MWSDESCNO = '" & LBLMWSNO.Text & "'"
            End With
            OleDBDR = OleDBC.ExecuteReader
