    ...
    Sub showItemAcquire()
        Try
            ...
            If CheckBox1.Checked = True Then
                With OleDBC
                    .Connection = conn
                    .CommandText = "SELECT dbo.tblMISDESC.[DATE],dbo.tblMISITEM.MATERIALDESC,dbo.tblMISITEM.SERIAL,dbo.tblMISITEM.ACCNO,dbo.tblMISITEM.UNIT" & _
    ...
    Sub SearchItemAcquire()
        Try
            ...
            If CheckBox1.Checked = True Then
                With OleDBC
                    .Connection = conn
                    .CommandText = "SELECT dbo.tblMISDESC.[DATE],dbo.tblMISITEM.MATERIALDESC,dbo.tblMISITEM.SERIAL,dbo.tblMISITEM.UNIT" & _
                        ",dbo.tblMISITEM.QTY,dbo.tblMISITEM.ACQUISITIONUNITCOST,dbo.tblMISDESC.ISRECEIVED FROM dbo.tblMISDESC INNER JOIN dbo.tblMISITEM ON " & _
            ...
            Else
                With OleDBC
                    .Connection = conn
                    .CommandText = "SELECT dbo.tblMISDESC.[DATE],dbo.tblMISITEM.MATERIALDESC,dbo.tblMISITEM.SERIAL,dbo.tblMISITEM.ACCOUNTDEBIT,dbo.tblMISITEM.UNIT" & _
                        ",dbo.tblMISITEM.QTY,dbo.tblMISITEM.ACQUISITIONUNITCOST,dbo.tblMISDESC.ISRECEIVED FROM dbo.tblMISDESC INNER JOIN dbo.tblMISITEM ON " & _
                        "dbo.tblMISDESC.MISNO = dbo.tblMISITEM.MISNO where DATE between '" & Format(dtpFrom.Value, "MM/dd/yyyy") & _
