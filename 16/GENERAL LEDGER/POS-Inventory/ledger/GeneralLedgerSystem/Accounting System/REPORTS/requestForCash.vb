...
Public Class requestForCash
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GeneralLedgerSystem.requestForCash.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrequestForCash
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As requestForCash = New requestForCash()
        rpt.Site = Me.Site
        Return rpt
    End Function
