...
Public Class paySlipPerson
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DTRandPayrollSystem.paySlipPerson.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpaySlipPerson
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As paySlipPerson = New paySlipPerson()
        rpt.Site = Me.Site
        Return rpt
    End Function
