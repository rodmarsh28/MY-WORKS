Public Class frmMasterList
        ...
        Try
            ...
            If OleDBDR.HasRows Then
                If OleDBDR.Read Then
                    ...
                    frmAddEmployees.ym.Text = DateDiff(DateInterval.Month, OleDBDR.Item(4), Now)
                End If
                updateSpouseInfo()
                updateChildrenInfo()
    ...
    Private Sub ViewDiscplinaryActionToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewDiscplinaryActionToolStripMenuItem.Click
    ...
    Private Sub DesciplinaryActionToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DesciplinaryActionToolStripMenuItem.Click
        Try
            ...
            If OleDBDR.HasRows Then
                If OleDBDR.Read Then
                    frmDescplinaryAction.txtEmpID.Text = OleDBDR.Item(0)
