...
Partial Public Class dataset
    ...
    Partial Public Class PAYROLLTABLEDataTable
        ...
        Public Overloads Function AddPAYROLLTABLERow( _
                    ...
                    ByVal totalallNet As String) As PAYROLLTABLERow
            Dim rowPAYROLLTABLERow As PAYROLLTABLERow = CType(Me.NewRow,PAYROLLTABLERow)
            Dim columnValuesArray() As Object = New Object() {DATERANGE, Name, Worked_Days, Holidays, NonWorkingHolidays, leavepay, _overtime_HRS_, _lateundertime_min_, Basic_Pay, RegularHolidayCash, NonWorkingHolidaysCash, Leave_Pay, _Overtime___Restday_Report, Gross_Pay, _Late___Undertime, SSS_Premiums, Pagibig_Premiums, Philhealth_Premiums, Cash_Advance, Total_Deduction, Net_Pay, _DATE, totalAllDed, totalAllGross, totalallNet}
