Public Class frmAccountingSystem
    ...
    Private Sub CREATEREQUESTFORPAYMENTToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CREATEREQUESTFORPAYMENTToolStripMenuItem.Click
        frmRequestForPayment.txtPreparedBy.Text = MainForm.LBLNAME.Text
        frmRequestForPayment.ShowDialog()
    End Sub

    Private Sub REQUESTFORCASHToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles REQUESTFORCASHToolStripMenuItem1.Click
        frmRequestForCash.ShowDialog()
    End Sub

    Private Sub REQUESTFORCASHToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles REQUESTFORCASHToolStripMenuItem.Click
        frmViewRFC.ShowDialog()
    End Sub
End Class