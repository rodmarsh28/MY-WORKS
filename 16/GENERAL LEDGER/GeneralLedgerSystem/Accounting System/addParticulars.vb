Public Class addParticulars
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            frmCheckVoucher.dgw.Item(0, row).Value = txtParticulars.Text
            frmCheckVoucher.dgw.Item(1, row).Value = txtAmount.Text
            frmCheckVoucher.Totamount = frmCheckVoucher.Totamount + txtAmount.Text
            frmCheckVoucher.lblTotAmount.Text = CDbl(frmCheckVoucher.Totamount).ToString("#,##0.00")
            Me.Close()
        End If
