...
Public Class GFLS_Payslip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GFLSPayrollSystem.GFLS Payslip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGFLS_Payslip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GFLS_Payslip = New GFLS_Payslip()
        rpt.Site = Me.Site
        Return rpt
    End Function
