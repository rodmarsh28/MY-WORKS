...
-- ----------------------------
INSERT INTO [dbo].[tblPayroll]  VALUES (N'PR-00001', N'2018-08-02 00:00:00.0000000', N'2018-07-01 00:00:00.0000000', N'2018-07-15 00:00:00.0000000', N'2', N'.0000', N'15000.0000', N'.0000', N'15000.0000', N'Rodmar Dumago', N'Payroll Generated:08/02/2018')
GO

INSERT INTO [dbo].[tblPayroll]  VALUES (N'PR-00002', N'2018-08-02 00:00:00.0000000', N'2018-07-16 00:00:00.0000000', N'2018-07-31 00:00:00.0000000', N'2', N'.0000', N'14975.9600', N'1093.4700', N'13882.4900', N'Rodmar Dumago', N'Payroll Generated:08/02/2018')
GO
...
INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [empID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'55', N'PR-00001', N'EMP-00001', N'.0000', N'0', N'0', N'0', N'.0000', N'0', N'10000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'10000.0000', N'.0000', N'10000.0000')
GO

INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [empID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'56', N'PR-00001', N'EMP-00002', N'.0000', N'0', N'0', N'0', N'.0000', N'0', N'5000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'5000.0000', N'.0000', N'5000.0000')
GO

INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [empID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'57', N'PR-00002', N'EMP-00002', N'.0000', N'0', N'0', N'0', N'.0000', N'0', N'5000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'5000.0000', N'.0000', N'5000.0000')
GO

INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [empID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'58', N'PR-00002', N'EMP-00001', N'.0000', N'0', N'0', N'0', N'.0000', N'15', N'10000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'24.0400', N'.0000', N'.0000', N'581.3000', N'237.5000', N'274.6700', N'.0000', N'.0000', N'.0000', N'9975.9600', N'1093.4700', N'8882.4900')
GO
