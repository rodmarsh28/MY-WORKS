...
Public Class Utility_Payroll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GFLSPayrollSystem.Utility Payroll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUtility_Payroll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Utility_Payroll = New Utility_Payroll()
        rpt.Site = Me.Site
        Return rpt
    End Function
