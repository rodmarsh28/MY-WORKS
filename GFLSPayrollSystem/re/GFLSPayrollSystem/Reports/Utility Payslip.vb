...
Public Class Utility_Payslip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GFLSPayrollSystem.Utility Payslip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUtility_Payslip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Utility_Payslip = New Utility_Payslip()
        rpt.Site = Me.Site
        Return rpt
    End Function
