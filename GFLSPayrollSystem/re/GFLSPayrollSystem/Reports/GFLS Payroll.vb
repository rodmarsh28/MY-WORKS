...
Public Class GFLS_Payroll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GFLSPayrollSystem.GFLS Payroll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGFLS_Payroll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GFLS_Payroll = New GFLS_Payroll()
        rpt.Site = Me.Site
        Return rpt
    End Function
