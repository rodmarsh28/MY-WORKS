    ...
    Sub printPayroll()
        ...
        Try
            ...
            ElseIf databaseMode = "AC Inc." Then
                rptDoc = New AC_Payroll
            ElseIf databaseMode = "Utility" Then
                rptDoc = New Utility_Payroll
            End If
        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblEmployee.empid,dbo.tblPayroll.datefrom,dbo.tblPayroll.dateto,dbo.tblEmployee.lastname," & _
                                ...
                                "dbo.tblPayrollofEmployees.Deduction,dbo.tblPayrollofEmployees.grossPay,dbo.tblPayrollofEmployees.Netpay,dbo.tblPayrollofEmployees.leavePayCash FROM dbo.tblPayrollofEmployees INNER JOIN dbo.tblEmployee ON " & _
                ...
                While OleDBDR.Read
                    ...
                    While c < 2
                        dt.Rows.Add(OleDBDR.Item(0),
                                    ...
                                    Format(OleDBDR.Item(9), "N"), Format(OleDBDR.Item(10), "N"), Format(OleDBDR.Item(11), "N"), Format(OleDBDR.Item(12), "N"), Format(OleDBDR.Item(13), "N"),
                                    ...
                                    Format(OleDBDR.Item(18), "N"), Format(OleDBDR.Item(19), "N"), Format(OleDBDR.Item(20), "N"), Format(OleDBDR.Item(21), "N"),
                                     Format(OleDBDR.Item(22), "N"), Format(OleDBDR.Item(23), "N"), Format(OleDBDR.Item(24), "N"), Format(OleDBDR.Item(25), "N"),
                                      Format(OleDBDR.Item(26), "N"), Format(OleDBDR.Item(27), "N"), Format(OleDBDR.Item(28), "N"), Format(OleDBDR.Item(29), "N"), Format(OleDBDR.Item(30), "N"), Format(OleDBDR.Item(31), "N"))
                        c = c + 1
                    End While
                End While
            End If
            Dim rptDoc As CrystalDecisions.CrystalReports.Engine.ReportDocument
            If databaseMode = "GFLS" Then
                rptDoc = New GFLS_Payslip
            ElseIf databaseMode = "AC Inc." Then
                rptDoc = New AC_Payslip
            ElseIf databaseMode = "Utility" Then
                rptDoc = New Utility_Payslip
            End If
            rptDoc.SetDataSource(dt)
            frmReportViewer.CrystalReportViewer1.ReportSource = rptDoc
            frmLoading.Close()
