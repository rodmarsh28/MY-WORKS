Public Class frmPurchaseRequestSlip
    ...
    Sub autoCompleteAPPROVEDBY()
        Try
            ...
            With OleDBC
                .Connection = conn
                .CommandText = "SELECT Distinct APPROVEDBY from tblPRSDESC "
            End With
    ...
    Sub autoCompleteUNIT()
        Try
            ...
            With OleDBC
                .Connection = conn
                .CommandText = "SELECT Distinct UNIT from tblPRSITEM "
            End With
            OleDBDR = OleDBC.ExecuteReader
            If OleDBDR.HasRows Then
                While OleDBDR.Read
    ...
    Sub autoCompletetype()
        Try
            ...
            With OleDBC
                .Connection = conn
                .CommandText = "SELECT Distinct TYPE from tblPRSITEM "
            End With
            OleDBDR = OleDBC.ExecuteReader
            If OleDBDR.HasRows Then
                While OleDBDR.Read
                ...
                txtSerial.AutoCompleteCustomSource = col
                txtSerial.AutoCompleteMode = AutoCompleteMode.Suggest
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If txtMaterialDesc.Text = "" Or txtUnit.Text = "" Or txtQuantity.Text = "" Then
        Else
            addtoDGW()
        End If
        dgw.ClearSelection()
