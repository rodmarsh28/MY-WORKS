            ...
            If CheckBox1.Checked = True Then
                With OleDBC
                    ...
                    .CommandText = "select * from tblMWSDESC where date between '" & Format(dtpFrom.Value, "MM/dd/yyyy") & "' and '" & Format(dtpTo.Value, "MM/dd/yyyy") & _
                        "' and MWSDESCNO like '%" & txtID.Text & "%' OR date between '" & Format(dtpFrom.Value, "MM/dd/yyyy") & "' and '" & Format(dtpTo.Value, "MM/dd/yyyy") & _
                        "' and TYPE like '%" & txtID.Text & "%' order by date desc"
                End With
            Else
                ...
                With OleDBC
                    .Connection = conn
                    .CommandText = "select * from tblMWSDESC where date between '" & Format(dtpFrom.Value, "MM/dd/yyyy") & "' and '" & Format(dtpTo.Value, "MM/dd/yyyy") & _
                        "' and MWSDESCNO like '%" & txtID.Text & "%' and ISISSUED = 'YES' OR date between '" & Format(dtpFrom.Value, "MM/dd/yyyy") & "' and '" & Format(dtpTo.Value, "MM/dd/yyyy") & _
                        "' and TYPE like '%" & txtID.Text & "%' order by date desc"
                End With
            End If
        ...
        Try
            ...
            If OleDBDR.HasRows Then
                While OleDBDR.Read
                    ...
                    dgw.Item(0, c).Value = Format(OleDBDR.Item(1), "MM/dd/yyyy")
                    dgw.Item(1, c).Value = OleDBDR.Item(0)
                    dgw.Item(2, c).Value = OleDBDR.Item(9)
        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblMRSDESC.MRSNO,dbo.tblMRSDESC.[DATE],dbo.tblMRSDESC.POREFNO,dbo.tblMRSDESC.DR,dbo.tblMRSDESC.SUPPLIERNAME," & _
                    ...
                    "dbo.tblMRSITEM.TYPE,dbo.tblMRSITEM.UNIT,dbo.tblMRSITEM.QUANTITY FROM dbo.tblMRSITEM INNER JOIN dbo.tblMRSDESC ON dbo.tblMRSDESC.MRSNO = dbo.tblMRSITEM.MRSNO " & _
        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblPRSDESC.PRSNO,dbo.tblPRSDESC.[DATE],dbo.tblPRSDESC.REMARKS,dbo.tblPRSDESC.PREPAREDBY,dbo.tblPRSDESC.APPROVEDBY," & _
                    "dbo.tblPRSDESC.REQSTATUS,dbo.tblPRSITEM.ITEMDESC,dbo.tblPRSITEM.TYPE,dbo.tblPRSITEM.INVTYCODE,dbo.tblPRSITEM.UNIT,dbo.tblPRSITEM.QTY,dbo.tblPRSITEM.STOCKSONHAND" & _
        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblPODESC.PONO,dbo.tblPODESC.[DATE],dbo.tblPODESC.PRSREF,dbo.tblPODESC.SUPPLIERNAME,dbo.tblPODESC.ADDRESS," & _
                    ...
                    "dbo.tblPOITEM.TYPE,dbo.tblPOITEM.UNIT,dbo.tblPOITEM.UPRICE,dbo.tblPOITEM.LESSVAT,dbo.tblPOITEM.QTY,dbo.tblPOITEM.AMOUNT FROM dbo.tblPODESC " & _
