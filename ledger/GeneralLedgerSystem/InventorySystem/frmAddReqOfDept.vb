Public Class frmAddReqOfDept
    ...
    Sub dgwItemProcess()
        ...
        row1 = dgw.RowCount
        While col < row1
            MaterialDesc = dgw.Item(0, col).Value
            unit = dgw.Item(1, col).Value
            quantity = dgw.Item(2, col).Value
            saveItem()
            col = col + 1
    ...
    Sub addToDGW()
        dgw.ClearSelection()
        dgw.Rows.Add()
        dgw.Item(0, c).Value = txtMaterialDesc.Text
        dgw.Item(1, c).Value = txtUnit.Text
        dgw.Item(2, c).Value = txtQuantity.Text
        c = c + 1
        nocount = nocount + 1
        clear()
    End Sub
