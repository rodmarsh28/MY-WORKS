Public Class frmMaterialReceiving
    ...
    Sub selectMRSNo()
        ...
        Try
            ...
            If OleDBDR.Read Then
                ...
                txtMRSNo.Text = "MRR-" & Format(Val(StrID) + 1, "00000")

            Else
                txtMRSNo.Text = "MRR-00001"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If txtItemDesc.Text = "" Or txtSerial.Text = "" Or txtInvtyCode.Text = "" Or txtUnit.Text = "" Or txtQuantity.Text = "" Then
        Else
            addtoDGW()
    ...
    Private Sub txtUnitPrice_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
