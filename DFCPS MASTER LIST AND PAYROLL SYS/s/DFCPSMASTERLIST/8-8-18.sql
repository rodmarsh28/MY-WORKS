...
-- ----------------------------
INSERT INTO [dbo].[tblEmployeesInfo]  VALUES (N'EMP-00001', N'asdasda', N'asdasd', N'asdads', N'asdasdsa', N'sadasda', N'sadasdasd', N'asdasda', N'Male', N'2018-07-12 00:00:00.0000000', N'Single', N'', N'', N'adasdasd', N'12321', N'12', N'Daily', N'2018-07-12 00:00:00.0000000', N'Regular', N'Work Hours', N'', N'', N'', N'', N'', N'Employees Info Added 07/12/2018')
GO
...
INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [employeeID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'51', N'PR-00001', N'EMP-00001', N'0', N'0', N'0', N'0', N'0', N'0', N'10000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'10000.0000', N'.0000', N'10000.0000')
GO

INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [employeeID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'52', N'PR-00001', N'EMP-00002', N'0', N'0', N'0', N'0', N'0', N'0', N'5000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'5000.0000', N'.0000', N'5000.0000')
GO

INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [employeeID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'53', N'PR-00002', N'EMP-00001', N'0', N'0', N'0', N'0', N'0', N'0', N'10000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'581.3000', N'250.0000', N'275.0000', N'.0000', N'.0000', N'.0000', N'10000.0000', N'1106.3000', N'8893.7000')
GO

INSERT INTO [dbo].[tblPayrollofEmployees] ([empPayrollTransNo], [payrollID], [employeeID], [absent], [regHolidays], [NonWorkHolidays], [leavePay], [overtimeHRS], [lateUTMins], [basicPay], [absentInAmount], [regHolidayPay], [nonWorkHolidayPay], [leavePayCash], [overtimePay], [lateUndertimeDed], [cashAdvance], [wHoldingTax], [sssPrems], [piPrems], [phPrems], [sssLoans], [piLoans], [ledgerBalance], [grossPay], [Deduction], [Netpay]) VALUES (N'54', N'PR-00002', N'EMP-00002', N'0', N'0', N'0', N'0', N'0', N'0', N'5000.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'.0000', N'5000.0000', N'.0000', N'5000.0000')
GO
