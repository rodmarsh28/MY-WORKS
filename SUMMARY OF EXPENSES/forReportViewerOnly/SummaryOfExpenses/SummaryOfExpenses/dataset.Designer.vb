...
Partial Public Class dataset
    ...
    Partial Public Class sumReportTableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddsumReportTableRow(ByVal _date As String, ByVal plateNo As String, ByVal vehicleModel As String, ByVal expenseType As String, ByVal noofYearsUsed As String, ByVal qty As String, ByVal unitPrice As String, ByVal totalPrice As String, ByVal datePeriod As String) As sumReportTableRow
            Dim rowsumReportTableRow As sumReportTableRow = CType(Me.NewRow,sumReportTableRow)
            Dim columnValuesArray() As Object = New Object() {_date, plateNo, vehicleModel, expenseType, noofYearsUsed, qty, unitPrice, totalPrice, datePeriod}
