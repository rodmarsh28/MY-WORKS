...
Module modconn
    ...
    Public Sub ConnectDatabase()
        If My.Settings.connectionType = "Local Database" Then
            strConnString = "Server=localhost;Database=dfcexpsum;Uid=root;"
        ElseIf My.Settings.connectionType = "Online Database" Then
            strConnString = "Server=db4free.net;Port=3306;Database=dfcexpsum;Uid=dfcship;Pwd=greatmarsh;old guids=true;"
        End If
