...
Public Class analytical_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SummaryOfExpenses.analytical Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedanalytical_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As analytical_Report = New analytical_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
