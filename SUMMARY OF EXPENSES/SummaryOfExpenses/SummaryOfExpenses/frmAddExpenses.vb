Public Class frmAddExpenses
    ...
    Sub selectType()
        Try
            ...
            With OleDBC
                .Connection = conn
                .CommandText = "SELECT DISTINCT expenseType FROM dbo.tblSummaryExpenses "
    ...
    Sub selectPrevOdo()
        Try
            ...
            With OleDBC
                .Connection = conn
                .CommandText = "SELECT currentOdometer FROM dbo.tblSummaryExpenses where vID = '" & vid & "' and expenseType = '" & cmbType.Text & "' order by currentOdometer desc "
